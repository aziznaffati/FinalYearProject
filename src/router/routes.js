    ...
    children: [
      {
        ...
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Ajout/Utlisateur')),
      },
     /* {
        path: 'Produit',
        name: 'Produit',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Ajout/Produit')),
      },*/
      {
        path: 'PDA',
        name: 'PDA',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Ajout/PDA')),
      },
     /* {
        path: 'contenaire',
        name: 'Contenaire',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Ajout/contenaire')),
      },*/
    ],
  }
];

/*const MiseàjourAppsRoutes = [
  {
    path: '/apps/Miseàjour',
    name: 'Miseàjour',
    icon: 'refresh-cw',
    ...
    children: [
      {
        ...
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Miseàjour/Utilisateurs')),
      },
     /* {
        path: 'Produits',
        name: 'Produits',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Miseàjour/Produits')),
      },*/
      /*{
        path: 'PDAs',
        name: 'PDAs',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Miseàjour/PDAs')),
      },*/
     /* {
        path: 'Chariots',
        name: 'Chariots',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Miseàjour/Chariots')),
      },
      {
        path: 'contenaire',
        name: 'Contenaire',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Miseàjour/contenaire')),
      },
    ],
  }
];*/

const AffichageAppsRoutes = [
  {
    path: '/apps/Affichage',
    name: 'Affichage, Suppresion,Mise à jour',
    icon: 'eye',
    meta: { authRequired: true },
    // create a container component
    component: {
    ...
    children: [
      {
        name: 'Les Utilisateures',
        path: 'Utilisateures',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Affichage/Utilisateures')),
      },
      {
        path: 'Produits',
        name: 'Les Produits',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Affichage/Produits')),
      },
      {
        path: 'PDAs',
        name: 'Les PDAs',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Affichage/PDAs')),
      },
      {
        path: 'Stock',
        name: 'Stock',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Affichage/Stock')),
      },
      {
        path: 'Pannes',
        name: 'Les Pannes',
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Affichage/Pannes')),
      },
     
      {
        ...
        meta: { authRequired: true },
        component: () =>
          lazyLoadView(import('@views/pages/apps/Affichage/contenaire')),
      },
